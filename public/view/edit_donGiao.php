...
if (isset($_GET['maVanDon'])) {
    ...
    try {
        ...
        $stmt->bind_param("si", $maVanDon, $_SESSION['user_id']);
        $stmt->execute();
    ...
    <?php if ($order): ?>
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-warning text-dark">
                <h2 class="mb-0">Chỉnh sửa đơn hàng: <?php echo htmlspecialchars($order['maVanDon']); ?></h2>
            </div>
            <div class="card-body">
