    ...
    if (isset($_GET['maVanDon'])) {
        ...
        try {
            ...
            $sql = "SELECT o.maVanDon, o.ngayTaoDon, o.COD, o.giaTriHang, o.ghiChu,
                           ...
                           GROUP_CONCAT(CONCAT(sp.tenSanPham, ' (', sp.soLuong, ')') SEPARATOR ', ') as products,
                           SUM(sp.khoiLuong) as totalWeight
                    FROM donHang o
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>Khối lượng:</th>
                                    <td><?php echo number_format($order['totalWeight'] ?? 0, 0, ',', '.'); ?> gam</td>
                                </tr>
                                <tr>
                                    <th>Giá trị hàng:</th>
                            ...
                            <?php if ($order['trangThai'] === 'Đã tạo'): ?>
                            <div class="mt-3">
                                <button class="btn btn-danger" onclick="cancelOrder('<?php echo htmlspecialchars($order['maVanDon']); ?>')">Hủy đơn hàng</button>
                            </div>
                            <?php endif; ?>
                        </div>
